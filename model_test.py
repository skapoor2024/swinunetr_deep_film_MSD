...
from gg_tools import get_test_loader, dice_score, TEMPLATE, get_key_2, NUM_CLASS, ORGAN_NAME, organ_post_process, dice_score_np
...
def process(args):
    ...
    val_loader,val_transforms = get_test_loader(args)
