...
ORGAN_DATASET_DIR = '/blue/kgong/s.kapoor/language_guided_segmentation/CLIP-Driven-Universal-Model/MSD_10_organ/'
ORGAN_LIST = '/blue/kgong/s.kapoor/language_guided_segmentation/CLIP-Driven-Universal-Model/MSD_10_organ/paot_10_test.txt'
NUM_WORKER = 8
#NUM_CLASS = 32
NUM_CLASS = 6 # taking those 10_MSD ONES
